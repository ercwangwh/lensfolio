...
export const getCollectModule = (selectedCollectModule: CollectModuleType): CollectModuleParams => {
  ...
  if (selectedCollectModule.isLimitedFeeCollect && !selectedCollectModule.isLimitedTimeFeeCollect) {
    return {
  ...
  if (selectedCollectModule.isFeeCollect && selectedCollectModule.isTimedFeeCollect) {
    return {
...
export const getCollectModuleConfig = (collectModule: string) => {
  switch (collectModule) {
    case 'FeeCollectModule':
      return {
        type: 'collectModule',
        description: 'Allow you to collect any publication by paying fees specified.'
      };
    case 'TimedFeeCollectModule':
      return {
        type: 'collectModule',
        description: 'Allow you to collect any publication within the time limit specified.'
      };
    case 'LimitedFeeCollectModule':
      return {
        type: 'collectModule',
        description: 'Allow you to collect any publication with the collect limit specified.'
      };
    case 'LimitedTimedFeeCollectModule':
      return {
        type: 'collectModule',
        description: 'Allow you to collect any publication with the time and collect limit specified.'
      };
    case 'FeeFollowModule':
      return {
        type: 'followModule',
        description: 'Allows you to join any profile by paying a fee specified by the profile owner.'
      };
    default:
      return {
        type: '',

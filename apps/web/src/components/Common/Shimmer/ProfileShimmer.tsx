...
export const ProfileCoverShimmer = () => {
  return (
    <div className="flex items-center justify-center px-4 md:px-0">
      <div className="relative flex flex-col w-full rounded-xl h-36 sm:h-96">
  ...
  return (
    <div className="md:mb-10 flex-1 space-y-5 flex flex-col w-full items-center justify-center">
      <div className="relative -mt-10 w-32 h-32 sm:-mt-24 sm:w-44 sm:h-44">
        <div className="w-32 h-32 dark:bg-gray-700/40 dark:ring-gray-700/60 bg-gray-300/70 ring-2 ring-white/70 bg-clip-padding backdrop-blur-xl backdrop-filter p-3 rounded-lg sm:w-44 sm:h-44 animate-pulse" />
      </div>
